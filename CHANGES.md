...
* Added `--readlengthdist-binwidth` command-line parameter to allow user-defined bin widths for read length distribution plots. Default behavior (dynamic interpolation with 10,000 points) is preserved when parameter is not specified. This fixes #38 (Pull Request from @phpeters-vbcf) ([#73](https://github.com/GenomiqueENS/toulligQC/issues/73)) ([eefe88b](https://github.com/GenomiqueENS/toulligQC/commit/eefe88b23b402c1dbf28db07e36bd1bb2e3a4d75))
* Added barcode-specific read length distribution plots displayed below existing barcode boxplots. Plots are arranged in a grid layout with 4 columns per row, with all subplots sharing a unified x-axis scale for direct comparison across barcodes. They are matching the style of the main "Distribution of read lengths" plot. (Pull Request from @phpeters-vbcf) ([#73](https://github.com/GenomiqueENS/toulligQC/issues/73)) ([eefe88b](https://github.com/GenomiqueENS/toulligQC/commit/eefe88b23b402c1dbf28db07e36bd1bb2e3a4d75))
* Added `--substitute parameter` to override values in the Run statistics table of the HTML report. Accepts comma-separated Measure,Value pairs (e.g., `--substitute "Sample ID,M21344,Experiment group,request3"`). Includes a) validation for proper pair formatting (even number of fields) performed at program start to fail fast on invalid input, and b) warnings for non-existent Measure names. (Pull Request from @phpeters-vbcf) ([#73](https://github.com/GenomiqueENS/toulligQC/issues/73)) ([eefe88b](https://github.com/GenomiqueENS/toulligQC/commit/eefe88b23b402c1dbf28db07e36bd1bb2e3a4d75))
